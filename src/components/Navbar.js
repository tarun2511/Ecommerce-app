...
export default function Navbar (){
    ...
    return(
        ...
        <ul className="nav" >
          <li className="nav-el"><AccountCircleIcon sx={{display: "inline-flex", verticalAlign: "text-bottom" }}/> </li>
          <Link to="/AddProduct" style={{textDecoration: "none", color: "white"}}><li className="nav-el"><AddBusinessIcon sx={{display: "inline-flex", verticalAlign: "text-bottom" }}/> </li></Link>
        </ul>
        </nav>
